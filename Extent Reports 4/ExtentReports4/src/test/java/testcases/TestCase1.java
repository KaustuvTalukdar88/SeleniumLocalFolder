...
public class TestCase1 {
	...
	public void setReport() {
		...
		extent.setSystemInfo("Automation Tester", "Kaustuv Talukdar");
	...
	public void doUserRegistration() {
		test = extent.createTest("UserRegistration Test");
		Assert.fail("UserRegistration Test failed");
	}

	@Test
	public void isSkip() {
		test = extent.createTest("Skip Test");
		System.out.println("Executing isSkip Test");
